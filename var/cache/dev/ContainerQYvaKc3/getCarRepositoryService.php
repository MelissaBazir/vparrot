...
class getCarRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\CarRepository'])) {
            return $container->privates['App\\Repository\\CarRepository'];
        }

        return $container->privates['App\\Repository\\CarRepository'] = new \App\Repository\CarRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a);
    }
}
