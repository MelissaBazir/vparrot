...
class __TwigTemplate_faa11bd608cde0f6cfd66642258de715 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "company/edit.html.twig"));
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Garage V. PARROT - Modification Société";
...
";
        // line 7
        $this->loadTemplate("profile/profile/admin.html.twig", "company/edit.html.twig", 7)->display($context);
        // line 8
        echo "    <div class=\"col-8\">
        <h1 class=\"mb-4\">Modifier la société ";
        // line 9
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["company"]) || array_key_exists("company", $context) ? $context["company"] : (function () { throw new RuntimeError('Variable "company" does not exist.', 9, $this->source); })()), "name", [], "any", false, false, false, 9), "html", null, true);
        echo "</h1>
        <a href=\"";
        // line 10
        ...
        // line 22
        echo "            ";
        echo twig_include($this->env, $context, "company/_form.html.twig", ["button_label" => "Modifier"]);
        echo "
            ";
        // line 23
...
";
    ...
    {
        return array (  122 => 24,  118 => 23,  113 => 22,  109 => 13,  104 => 11,  100 => 10,  96 => 9,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Garage V. PARROT - Modification Société{% endblock %}

{% block body %}
<div class=\"container d-flex\">
{% include \"profile/profile/admin.html.twig\" %}
    <div class=\"col-8\">
        <h1 class=\"mb-4\">Modifier la société {{company.name}}</h1>
        <a href=\"{{ path('app_company_index') }}\" class=\"btn btn-outline-secondary my-3\">Retour à la liste</a>
        {{ form_errors(form) }}
...
{% endblock %}
", "company/edit.html.twig", "C:\\wamp64\\www\\symfony\\vparrot\\templates\\company\\edit.html.twig");
    }
}
