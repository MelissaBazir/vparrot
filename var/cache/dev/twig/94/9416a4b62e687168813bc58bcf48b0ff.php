...
class __TwigTemplate_e4e7acb9ba60665aa8f91e3b16f43889 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Garage V. PARROT - Modification Employé";
...
";
        // line 7
        $this->loadTemplate("profile/profile/admin.html.twig", "admin/user/edit.html.twig", 7)->display($context);
        // line 8
        echo "    <div class=\"col-8\">
        <h1 class=\"mb-4\">Modifier l'employé ";
        // line 9
...
";
    ...
    {
        return array (  123 => 16,  119 => 15,  115 => 14,  111 => 13,  106 => 11,  102 => 10,  96 => 9,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Garage V. PARROT - Modification Employé{% endblock %}

{% block body %}
<div class=\"container d-flex\">
{% include \"profile/profile/admin.html.twig\" %}
    <div class=\"col-8\">
        <h1 class=\"mb-4\">Modifier l'employé {{user.firstname}} {{user.lastname}}</h1>
        <a href=\"{{ path('admin_user_index') }}\" class=\"btn btn-outline-secondary my-3\">Retour à la liste</a>
        {{ form_errors(form) }}
...
{% endblock %}
", "admin/user/edit.html.twig", "C:\\wamp64\\www\\symfony\\vparrot\\templates\\admin\\user\\edit.html.twig");
    }
}
