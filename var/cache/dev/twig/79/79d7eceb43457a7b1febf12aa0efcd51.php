...
class __TwigTemplate_68b2aa3f9777491a7364b423b17d4df8 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Garage V. PARROT - Nouveau Service";
    ...
    <h1 class=\"my-5\">Créer un service </h1>
</div>
<div class=\"container d-flex justify-content-center\">
    <div class=\"col-8\">
        ...
        echo "
                ";
        // line 14
        echo twig_include($this->env, $context, "service/_form.html.twig", ["button_label" => "Créer le service"]);
        echo "
                <a href=\"";
        // line 15
...
{% block title %}Garage V. PARROT - Nouveau Service{% endblock %}
...
<div class=\"container d-flex justify-content-center\">
    <div class=\"col-8\">
        ...
        {{ form_start(form) }}
                {{ include('service/_form.html.twig', {'button_label': 'Créer le service'}) }}
                <a href=\"{{ path('app_service_index') }}\" class=\"btn btn-dark my-3\">Retour à la liste</a>        {{ form_end(form) }}
        {{ form_end(form) }}
    </div>
</div>
{% endblock %}
", "service/new.html.twig", "C:\\wamp64\\www\\symfony\\vparrot\\templates\\service\\new.html.twig");
    }
}
