...
class __TwigTemplate_8c824ce44d9c6ca092f83e0876087e8a extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_service_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["service"]) || array_key_exists("service", $context) ? $context["service"] : (function () { throw new RuntimeError('Variable "service" does not exist.', 27, $this->source); })()), "id", [], "any", false, false, false, 27)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "service/show.html.twig", "C:\\wamp64\\www\\symfony\\vparrot\\templates\\service\\show.html.twig");
    }
}
