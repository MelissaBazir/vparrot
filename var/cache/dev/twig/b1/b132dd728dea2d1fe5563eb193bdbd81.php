...
class __TwigTemplate_6bb09c6debab9c2a04808f1f4907fae8 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Garage V. PARROT - Modification Avis";
    ...
    ";
        // line 7
        $this->loadTemplate("profile/profile/admin.html.twig", "review/edit.html.twig", 7)->display($context);
        // line 8
        echo "    <div class=\"col-8\">
        <h1 class=\"mb-4\">Modifier l'avis ";
        // line 9
        echo twig_escape_filter($this->env, twig_title_string_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["review"]) || array_key_exists("review", $context) ? $context["review"] : (function () { throw new RuntimeError('Variable "review" does not exist.', 9, $this->source); })()), "title", [], "any", false, false, false, 9)), "html", null, true);
        echo " </h1>
        ...
        echo "
                ";
        // line 15
        echo twig_include($this->env, $context, "review/_form.html.twig", ["button_label" => "Modifier"]);
        echo "
                ";
        // line 16
...
{% block title %}Garage V. PARROT - Modification Avis{% endblock %}

{% block body %}
<div class=\"container d-flex\">
    {% include \"profile/profile/admin.html.twig\" %}
    <div class=\"col-8\">
        <h1 class=\"mb-4\">Modifier l'avis {{review.title|title}} </h1>
    
        <a href=\"{{ path('app_review_index') }}\" class=\"btn btn-outline-secondary my-3\">Retour à la liste</a>
            {{ form_errors(form) }}

            {{ form_start(form) }}
                {{ include('review/_form.html.twig', {'button_label': 'Modifier'}) }}
                {{ include('review/_delete_form.html.twig') }}
            {{ form_end(form) }}
    </div>
</div>
{% endblock %}", "review/edit.html.twig", "C:\\wamp64\\www\\symfony\\vparrot\\templates\\review\\edit.html.twig");
    }
}
