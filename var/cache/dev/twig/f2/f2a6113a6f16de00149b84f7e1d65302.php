...
class __TwigTemplate_21c1e763d568377a82dbe5aba3cfc5e4 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Garage V. PARROT - Nouvel Avis";
    ...
    <h1 class=\"my-5\">Créer un avis </h1>
</div>
<div class=\"container d-flex justify-content-center\">
    <div class=\"col-8\">
        ...
        echo "
            ";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "textReview", [], "any", false, false, false, 15), 'row');
        echo "
            ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "score", [], "any", false, false, false, 16), 'row');
        echo "
            ";
        // line 17
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 20, $this->source); })()), "user", [], "any", false, false, false, 20)) {
            // line 21
            echo "                ";
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 21, $this->source); })()), "isApproved", [], "any", false, false, false, 21), 'row');
            echo "
                <a href=\"";
            // line 22
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_review_index");
            echo "\" class=\"btn btn-dark mb-3\">Retour à la liste</a>     
                ";
        }
        // line 24
        echo "                <button type=\"submit\" class=\"btn btn-primary mb-3\">Créer l'avis</button>
        ";
        // line 25
...
";
    ...
    {
        return array (  137 => 25,  134 => 24,  129 => 22,  124 => 21,  121 => 20,  116 => 17,  112 => 16,  108 => 15,  104 => 14,  100 => 13,  95 => 11,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Garage V. PARROT - Nouvel Avis{% endblock %}
    ...
    <div class=\"col-8\">
        ...
        {{ form_start(form) }}
            ...
            {{ form_row(form.email) }}
                ...
                {# {{ include('review/_form.html.twig', {'button_label': 'Créer l\\'avis'}) }} #}
                {% if app.user %}
                {{ form_row(form.isApproved) }}
                <a href=\"{{ path('app_review_index') }}\" class=\"btn btn-dark mb-3\">Retour à la liste</a>     
                {% endif %}
                <button type=\"submit\" class=\"btn btn-primary mb-3\">Créer l'avis</button>
...
", "review/new.html.twig", "C:\\wamp64\\www\\symfony\\vparrot\\templates\\review\\new.html.twig");
    }
}
