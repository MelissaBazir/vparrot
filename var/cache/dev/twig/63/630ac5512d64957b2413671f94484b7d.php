...
class __TwigTemplate_6d599c92a36f4515658350715702ed8c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Garage V. PARROT - Connexion";
    ...
    <div class=\"row\">
        ...
        echo " \" class=\"btn btn-outline-dark mt-3\">Mot de passe oublié</a>
            </form>
        </div>
    </div>
</section>
...
";
    ...
    {
        return array (  140 => 33,  131 => 27,  123 => 22,  118 => 19,  110 => 16,  107 => 15,  105 => 14,  102 => 13,  96 => 11,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Garage V. PARROT - Connexion{% endblock %}
    ...
    <div class=\"row\">
        <div class=\"col\">
            <form method=\"post\">
                ...
                {% if app.user %}
                    <div class=\"mb-3\">
                        Vous êtes connecté comme {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Me déconnecter</a>
                    </div>
                {% endif %}
                ...
                <a href=\" {{ path('forgotten_password') }} \" class=\"btn btn-outline-dark mt-3\">Mot de passe oublié</a>
            </form>
        </div>
    </div>
</section>
...
{% endblock %}
", "security/login.html.twig", "C:\\wamp64\\www\\symfony\\vparrot\\templates\\security\\login.html.twig");
    }
}
