...
class __TwigTemplate_4b6ed1c1ca15855358ad8a1eb46ccd47 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Garage V. PARROT - Modification Service";
    ...
    ";
        // line 7
        $this->loadTemplate("profile/profile/admin.html.twig", "service/edit.html.twig", 7)->display($context);
        // line 8
        echo "    <div class=\"col-8\">
        <h1 class=\"my-5\">Modifier le service ";
        // line 9
        echo twig_escape_filter($this->env, twig_title_string_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["service"]) || array_key_exists("service", $context) ? $context["service"] : (function () { throw new RuntimeError('Variable "service" does not exist.', 9, $this->source); })()), "title", [], "any", false, false, false, 9)), "html", null, true);
        echo " </h1>

        <a href=\"";
        // line 11
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_service_index");
        echo "\" class=\"btn btn-outline-secondary my-3\">Retour à la liste</a>
        ";
        // line 12
...
";
    ...
    {
        return array (  122 => 17,  118 => 16,  114 => 15,  110 => 14,  105 => 12,  101 => 11,  96 => 9,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Garage V. PARROT - Modification Service{% endblock %}

{% block body %}
<div class=\"container d-flex\">
    {% include \"profile/profile/admin.html.twig\" %}
    <div class=\"col-8\">
        <h1 class=\"my-5\">Modifier le service {{service.title|title}} </h1>

        <a href=\"{{ path('app_service_index') }}\" class=\"btn btn-outline-secondary my-3\">Retour à la liste</a>
        {{ form_errors(form) }}
...
{% endblock %}
", "service/edit.html.twig", "C:\\wamp64\\www\\symfony\\vparrot\\templates\\service\\edit.html.twig");
    }
}
